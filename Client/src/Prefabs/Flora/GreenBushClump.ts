...
export default class GreenBushClump extends Phaser.GameObjects.Container {
    ...
    constructor(
        ...
        scene.load.image('bush_green_1', 'bush_green_1.png')
        scene.add.existing(this);

        
        const orangeBush = scene.add.image( this.x, this.y, 'bush_green_1')
        orangeBush.scale = 2
        const orangeBush3 = scene.add.image( this.x - 60 , this.y + 60, 'bush_green_1')
        orangeBush3.blendMode = Phaser.BlendModes.DIFFERENCE
        const orangeBush3Overlay = scene.add.image( this.x - 60, this.y + 60, 'bush_green_1')
        ...
        const orangeBush2 = scene.add.image( this.x + 40, this.y + 60, 'bush_green_1')
        orangeBush2.blendMode = Phaser.BlendModes.NORMAL
        const orangeBush2Overlay = scene.add.image( this.x + 40, this.y + 60, 'bush_green_1')
